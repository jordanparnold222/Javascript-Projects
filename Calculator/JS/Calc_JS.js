...
const Calculator = {
    ...
    //this will hold the 1st operand for any expressions, we set it to null for now.
    First_Operand: null,

    //This checks whether or not the 2nd operand has been inputted
    Wait_Second_Operand: false,

    //This will hold the 2nd operand. We set it to null for now.
    operator: null,
};

//This modifies values each time a button clicked.
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot))    {
        ...
        //We are sayig that is the Display_value  does not contain a decimal point, we want to add a decimal point
